	...
	`,
		"jummbox light": `
				:root {
					-webkit-text-stroke-width: 0.5px;
                    --page-margin: #e5e5e6;
                    --editor-background: #eeefff;
                    --hover-preview: #a25426;
                    --playhead: rgb(220 178 27 / 90%);
                    --primary-text: #712100;
                    --secondary-text: #a51446;
                    --inverted-text: #fefdff;
                    --text-selection: rgb(215 60 6 / 99%);
                    --box-selection-fill: rgba(30,62,220,0.5);
                    --loop-accent: #09dc0e;
                    --link-accent: #3ee669;
                    --ui-widget-background: #e0d4c0;
                    --ui-widget-focus: #d6b9ab;
                    --pitch-background: #deceac;
                    --tonic: #a16fb1;
                    --fifth-note: #d08c8c;
                    ...
                    --track-editor-bg-noise: #daa592;
                    --track-editor-bg-noise-dim: #cac5c2;
                    --track-editor-bg-mod: #9f81a2;
                    --track-editor-bg-mod-dim: #cdc8d0;
                    --multiplicative-mod-slider: #807caf;
                    --overwriting-mod-slider: #909cdf;
                    --indicator-primary: #ae38ff;
                    --indicator-secondary: #bbd4ec;
                    --select2-opt-group: #e0d4c0;
                    ...
                    --pitch-secondary-channel-hue: 32;
                    --pitch-secondary-channel-hue-scale: 24.1;
                    --pitch-secondary-channel-sat: 93.3;
                    --pitch-secondary-channel-sat-scale: -0.1;
					--pitch-secondary-channel-lum: 50;
					--pitch-secondary-channel-lum-scale: -0.05;
					--pitch-primary-channel-hue: 32;
					--pitch-primary-channel-hue-scale: 24.1;
					--pitch-primary-channel-sat: 97;
					--pitch-primary-channel-sat-scale: -0.1;
					--pitch-primary-channel-lum: 45.5;
					--pitch-primary-channel-lum-scale: -0.05;
					--pitch-secondary-note-hue: 32;
					--pitch-secondary-note-hue-scale: 24.1;
					--pitch-secondary-note-sat: 93.9;
					--pitch-secondary-note-sat-scale: -0.1;
					--pitch-secondary-note-lum: 70;
					--pitch-secondary-note-lum-scale: -0.05;
					--pitch-primary-note-hue: 32;
					--pitch-primary-note-hue-scale: 24.1;
					--pitch-primary-note-sat: 100;
					--pitch-primary-note-sat-scale: 0.05;
