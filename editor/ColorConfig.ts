	...
	`,
		...
		"roe": `
			:root {
				...
				--playhead: white;
				--primary-text: #b8cee0;
				--secondary-text: #b14e4e;
				--inverted-text: black;
				--text-selection: rgb(255 68 68 / 99%);
				--box-selection-fill: rgb(255 0 0 / 30%);
				--loop-accent: #7744FF;
				--link-accent: #FF2A2A;
				--ui-widget-background: #141e34;
				--ui-widget-focus: #202f51;
				--pitch-background: #15111a;
				--tonic: #1b3041;
				--fifth-note: #381818;
				--white-piano-key: #bebebe;
				--black-piano-key: #444;
				--use-color-formula: false;
				--track-editor-bg-pitch: #312939;
				--track-editor-bg-pitch-dim: #312939;
				...
				--multiplicative-mod-slider: #456;
				--overwriting-mod-slider: #654;
				--indicator-primary: #299EFF;
				--indicator-secondary: #FF2A2A;
