	...
	`,
		"jummbox light": `
				:root {
                    ...
                    --loop-accent: #09dc0e;
                    --link-accent: #3ee669;
                    --ui-widget-background: #fdf1d4;
                    --ui-widget-focus: #ffffff;
                    --pitch-background: #dcc492;
                    --tonic: #a16fb1;
                    --fifth-note: #d08c8c;
                    --white-piano-key: #fbffee;
                    --black-piano-key: #fecaff;
                    --white-piano-key-text: #0c0d52;
                    --black-piano-key-text: #231b03;
                    --use-color-formula: true;
                    --track-editor-bg-pitch: #f6ffbc;
                    --track-editor-bg-pitch-dim: #fff;
                    --track-editor-bg-noise: #dfffce;
                    --track-editor-bg-noise-dim: #fff;
                    --track-editor-bg-mod: #f2cfff;
                    --track-editor-bg-mod-dim: #fff;
                    --multiplicative-mod-slider: #807caf;
                    --overwriting-mod-slider: #909cdf;
                    --indicator-primary: #ae38ff;
                    --indicator-secondary: #bbd4ec;
                    --select2-opt-group: #f0d4e0;
