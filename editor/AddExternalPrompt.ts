...
export class AddExternalPrompt {
        constructor(_doc) {
            this._doc = _doc;
            //this.externalSamples = input({ style: "width: 18em; margin:5px margin-left: 0px;", type: "text"});
